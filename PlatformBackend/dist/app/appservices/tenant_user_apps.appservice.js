...
let Tenant_User_AppsAppService = class Tenant_User_AppsAppService extends AppServiceBase_1.default {
    constructor(tenant_user_appRepository, http) {
        super(http, tenant_user_appRepository, tenant_user_apps_entity_1.Tenant_User_App, tenant_user_apps_entity_1.Tenant_User_App, tenant_user_appsDto_1.Tenant_User_AppsDto, dto.tenant_user_appsentityJson, dto.tenant_user_appsdtoJson, dto.tenant_user_appsentityToDtoJson, dto.tenant_user_appsdtoToEntityJson);
        this.tenant_user_appRepository = tenant_user_appRepository;
        this.http = http;
    }
};
Tenant_User_AppsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tenant_user_apps_entity_1.Tenant_User_App)),
