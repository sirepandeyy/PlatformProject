...
let App_MessagesAppService = class App_MessagesAppService extends AppServiceBase_1.default {
    constructor(app_messagesRepository, http) {
        super(http, app_messagesRepository, app_messages_entity_1.App_Message, app_messages_entity_1.App_Message, app_messagesDto_1.App_MessagesDto, dto.app_messagesentityJson, dto.app_messagesdtoJson, dto.app_messagesentityToDtoJson, dto.app_messagesdtoToEntityJson);
...
App_MessagesAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(app_messages_entity_1.App_Message)),
