...
let Tenant_AppsAppService = class Tenant_AppsAppService extends AppServiceBase_1.default {
    constructor(tenant_appRepository, http) {
        super(http, tenant_appRepository, tenant_apps_entity_1.Tenant_App, tenant_apps_entity_1.Tenant_App, tenant_appsDto_1.Tenant_AppsDto, dto.tenant_appsentityJson, dto.tenant_appsdtoJson, dto.tenant_appsentityToDtoJson, dto.tenant_appsdtoToEntityJson);
        this.tenant_appRepository = tenant_appRepository;
        this.http = http;
    }
};
Tenant_AppsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tenant_apps_entity_1.Tenant_App)),
